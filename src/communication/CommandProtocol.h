 ...
 */
 ...
 private:
      ...
      * @return True if command processed successfully, false otherwise
      */
     bool processSystemCommand(uint8_t commandId, const uint8_t* data, uint8_t length, ResponsePacket& response);
      ...
      * @return True if command processed successfully, false otherwise
      */
     bool processMotionCommand(uint8_t commandId, const uint8_t* data, uint8_t length, ResponsePacket& response);
      ...
      * @return True if command processed successfully, false otherwise
      */
     bool processStatusCommand(uint8_t commandId, const uint8_t* data, uint8_t length, ResponsePacket& response);
      ...
      * @return True if command processed successfully, false otherwise
      */
     bool processConfigCommand(uint8_t commandId, const uint8_t* data, uint8_t length, ResponsePacket& response);
      ...
      * @return True if command processed successfully, false otherwise
      */
     bool processDebugCommand(uint8_t commandId, const uint8_t* data, uint8_t length, ResponsePacket& response);
