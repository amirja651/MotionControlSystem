 ...
 */
     ...
     while (Serial.available() > 0) {
         ...
         if (findCommandPacket(packet)) {
             ...
             if (packetSize < m_receiveBufferIndex) {
                 ...
                 memmove(m_receiveBuffer, m_receiveBuffer + packetSize, m_receiveBufferIndex - packetSize);
 ...
 bool CommandProtocol::processSystemCommand(uint8_t commandId, const uint8_t* data, uint8_t length, ResponsePacket& response) {
     // System commands:
 ...
 bool CommandProtocol::processMotionCommand(uint8_t commandId, const uint8_t* data, uint8_t length, ResponsePacket& response) {
     // Motion commands:
     // 0x01: Enable motor
     // 0x02: Disable motor
 ...
 bool CommandProtocol::processStatusCommand(uint8_t commandId, const uint8_t* data, uint8_t length, ResponsePacket& response) {
     // Status commands:
 ...
 bool CommandProtocol::processConfigCommand(uint8_t commandId, const uint8_t* data, uint8_t length, ResponsePacket& response) {
 ...
 bool CommandProtocol::processDebugCommand(uint8_t commandId, const uint8_t* data, uint8_t length, ResponsePacket& response) {
     // Debug commands:
     // 0x01: Set log level
     // 0x02: Get log buffer
         ...
         case 0x02: { // Get log buffer
             ...
             for (size_t i = 0; i < logCount; i++) {
                 ...
                 if (entry != nullptr) {
                     ...
                     uint8_t messageLength = entry->message.length() > 20 ? 20 : entry->message.length();
