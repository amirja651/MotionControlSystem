...
bool TrajectoryPlanner::planPositionMove(int32_t     currentPosition,
    ...
    if (profileType == ProfileType::S_CURVE) {
        m_state.profileDuration = calculateSCurveProfile(distance,
                                                         currentVelocity,
                                                         0.0f,
                                                         maxVelocity,
                                                         maxAcceleration,
...
bool TrajectoryPlanner::planVelocityMove(float       currentVelocity,
...
float TrajectoryPlanner::calculateSCurveProfile(float distance,
                                                float initialVelocity,
                                                float targetVelocity,
                                                float maxVelocity,
                                                float maxAcceleration,
